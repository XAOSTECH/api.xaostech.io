# Contributing to api.xaostech.io
...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/api.xaostech.io.git`
3. Add upstream remote: `git remote add upstream https://github.com/XAOSTECH/api.xaostech.io.git`
...
Feel free to open a [Discussion](https://github.com/XAOSTECH/api.xaostech.io/discussions) for questions or ideas.
